...
<head>
    ...
    <style>
    p{ display: block; margin: 20px 10px;}
...
<body>
    <h1>
        <?php
            foreach ($faq as $domanda => $arrayRisposta) {
        ?>
            <h1> <?php
                    echo $domanda
                ?>
                ...
                <?php
                    foreach ($arrayRisposta as $domanda => $risposta) {
                ?>
                    <p>
                <?php
                        echo $risposta;
